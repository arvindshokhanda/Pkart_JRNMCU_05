...
public class AdminController {
	...
	private static IProductService productService;		//Creating Object for Product Service Layer
	private static ICustomerService customerService;	//Creating Object for Customer Service Layer
	...
	public void operations() {
		...
		while (status) {
			...
			case 1:
				...
				if (productService.addProduct(p)) {				// adding Object
			...
			case 2:
				...
				System.out.println("enter product id which want to update:");	// updating product
